...
def main():
    ...
    parser.add_argument("-beta", "--beta", type=float, default=1, help="Beta for RMSprop")
    parser.add_argument("-beta1", "--beta1", type=float, default=0.9, help="Beta1 for Adam/Nadam")
    parser.add_argument("-beta2", "--beta2", type=float, default=0.99, help="Beta2 for Adam/Nadam")
